  ...
  return (
    <section className="min-h-[620px]">
      <div className="container mx-auto min-h-[620px]">
        ...
        <motion.div variants={staggerContainer} initial="hidden" whileInView={"show"} viewport={{ once: false, amount: 0.6 }} className="flex flex-col lg:flex-row items-center min-h-[620px]">
          {/* text */}
          <motion.div variants={fadeIn("right", "tween", 0.2, 1.8)} className="text-center lg:text-left flex-1">
